...
# target 10.8
      			...
      			MW_SDKROOT=`/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk`
            
            MACOSX_DEPLOYMENT_TARGET='10.11'
            ARCHS='x86_64'
            CFLAGS="-fno-common -arch $ARCHS -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET"
            CFLAGS="$CFLAGS  -fexceptions"
            CLIBS="$MLIBS"
...
#
            ...
            CXXFLAGS="-fno-common -fexceptions -arch $ARCHS -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET -stdlib=libc++"
	    CXXLIBS="-lc++"
